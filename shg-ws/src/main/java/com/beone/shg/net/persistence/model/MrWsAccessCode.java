...
@Entity
@Table(name="mr_ws_access_code"
,catalog="shg"
, uniqueConstraints = {  }
		)
public class MrWsAccessCode  implements java.io.Serializable {
	...
	/** default constructor */
	public MrWsAccessCode() {
	}

	public MrWsAccessCode(String accessCode, String accessCodeDisplay,
	...
	public MrWsAccessCode(int accessCodeId, String accessCode,
