...
@Entity
@Table(name="mr_ui_access_code"
,catalog="shg"
, uniqueConstraints = {  }
		)
public class MrUiAccessCode  implements java.io.Serializable {
	...
	/** default constructor */
	public MrUiAccessCode() {
	}

	public MrUiAccessCode(String accessCode, String accessCodeDisplay,
	...
	public MrUiAccessCode(int accessCodeId, String accessCode,
