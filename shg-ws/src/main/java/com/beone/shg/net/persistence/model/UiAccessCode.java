...
@Entity
@Table(name="ui_access_code"
,catalog="shg"
, uniqueConstraints = {  }
		)
public class UiAccessCode  implements java.io.Serializable {
	...
	public UiAccessCode(String accessCode, String accessCodeDisplay,
	...
	public UiAccessCode(int accessCodeId, String accessCode,
