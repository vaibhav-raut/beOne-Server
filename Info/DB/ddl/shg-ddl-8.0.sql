...
CREATE TABLE IF NOT EXISTS `shg`.`brand` (
  ...
  `no_to_stocked` INT(10) NULL,
  `no_total_stocked` INT(10) NULL,
  `no_stocked` INT(10) NULL,
  `no_sold` INT(10) NULL,
  `no_damage_returned` INT(10) NULL,
  `no_lots` INT(10) NULL,
  `no_per_set` INT(10) NULL,
  `no_min_sets` INT(10) NULL,
  `total_purchase_am` DECIMAL(16,2) NULL,
  `total_mr_purchase_am` DECIMAL(16,2) NULL,
  `total_mr_balance_am` DECIMAL(16,2) NULL,
  `total_mr_sold_am` DECIMAL(16,2) NULL,
  `total_mr_damage_returned_am` DECIMAL(16,2) NULL,
  `first_mr_price_am` DECIMAL(16,2) NULL,
  `last_mr_price_am` DECIMAL(16,2) NULL,
...
CREATE TABLE IF NOT EXISTS `shg`.`stock_tx` (
  ...
  `stock_tx_type_id` INT(10) UNSIGNED NOT NULL,
  `entry_by_ac_no` BIGINT(20) NULL,
  `owner_ac_no` BIGINT(20) NULL,
  `prev_owner_ac_no` BIGINT(20) NULL,
  ...
  INDEX `stock_tx_fk1_idx` (`stock_item_id` ASC),
  INDEX `stock_tx_fk3_idx` (`entry_by_ac_no` ASC),
  INDEX `stock_tx_fk4_idx` (`owner_ac_no` ASC),
  INDEX `stock_tx_fk5_idx` (`prev_owner_ac_no` ASC),
  CONSTRAINT `stock_tx_fk1`
    FOREIGN KEY (`stock_item_id`)
    REFERENCES `shg`.`stock_item` (`stock_item_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `stock_tx_fk3`
    FOREIGN KEY (`entry_by_ac_no`)
    REFERENCES `shg`.`m_profile` (`m_ac_no`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `stock_tx_fk4`
    FOREIGN KEY (`owner_ac_no`)
    REFERENCES `shg`.`p_m_ac` (`p_m_ac_no`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `stock_tx_fk5`
    FOREIGN KEY (`prev_owner_ac_no`)
    REFERENCES `shg`.`p_m_ac` (`p_m_ac_no`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
