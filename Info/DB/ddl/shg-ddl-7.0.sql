...
CREATE TABLE IF NOT EXISTS `shg`.`bank_account` (
  ...
  INDEX `bank_account_FKIndex1` (`account_type_id` ASC),
  INDEX `bank_account_ibfk_2_idx` (`b_g_ac_no` ASC),
  CONSTRAINT `bank_account_ibfk_1`
    FOREIGN KEY (`account_type_id`)
    REFERENCES `shg`.`bank_account_type` (`account_type_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS `shg`.`g_m` (
  ...
  INDEX `g_m_FKIndex1` (`g_ac_no` ASC),
  INDEX `g_m_FKIndex2` (`m_ac_no` ASC),
  CONSTRAINT `g_m_ibfk_1`
    FOREIGN KEY (`g_ac_no`)
    REFERENCES `shg`.`g_profile` (`g_ac_no`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `g_m_ibfk_2`
    FOREIGN KEY (`m_ac_no`)
...
CREATE TABLE IF NOT EXISTS `shg`.`m_saving_ac` (
  ...
  INDEX `m_saving_ac_FKIndex2` (`recovery_period_id` ASC),
  INDEX `m_saving_ac_FKIndex3` (`m_ac_no` ASC),
  INDEX `m_saving_ac_FKIndex4` (`account_status_id` ASC),
  CONSTRAINT `m_saving_ac_ibfk_1`
    FOREIGN KEY (`m_ac_no`)
    REFERENCES `shg`.`m_ac` (`m_ac_no`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `m_saving_ac_ibfk_2`
    FOREIGN KEY (`account_status_id`)
    REFERENCES `shg`.`account_status` (`account_status_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `m_saving_ac_ibfk_4`
    FOREIGN KEY (`recovery_period_id`)
    REFERENCES `shg`.`recovery_period` (`recovery_period_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `shg`.`tx` (
  ...
  `receipt_voucher_no` INT(10) UNSIGNED NULL,
  `cheque_no` INT(10) UNSIGNED NULL,
...
CREATE TABLE IF NOT EXISTS `shg`.`m_loan_ac` (
  ...
  INDEX `m_loan_ac_ibfk_2_idx` (`recovery_period_id` ASC),
  INDEX `m_loan_ac_ibfk_3_idx` (`m_ac_no` ASC),
  INDEX `m_loan_ac_ibfk_4_idx` (`account_status_id` ASC),
  INDEX `m_loan_ac_ibfk_1_idx` (`fund_type_id` ASC),
  INDEX `m_loan_ac_ibfk_5_idx` (`loan_calculation_id` ASC),
  INDEX `m_loan_ac_ibfk_6_idx` (`approved_by_m` ASC),
  INDEX `m_loan_ac_ibfk_7_idx` (`loan_source_id` ASC),
  CONSTRAINT `m_loan_ac_ibfk_1`
    FOREIGN KEY (`fund_type_id`)
    REFERENCES `shg`.`fund_type` (`fund_type_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `m_loan_ac_ibfk_2`
    FOREIGN KEY (`recovery_period_id`)
    REFERENCES `shg`.`recovery_period` (`recovery_period_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `m_loan_ac_ibfk_3`
    FOREIGN KEY (`account_status_id`)
    REFERENCES `shg`.`account_status` (`account_status_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `m_loan_ac_ibfk_4`
    FOREIGN KEY (`m_ac_no`)
    REFERENCES `shg`.`m_ac` (`m_ac_no`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `m_loan_ac_ibfk_5`
    FOREIGN KEY (`loan_calculation_id`)
    REFERENCES `shg`.`loan_calculation` (`loan_calculation_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `m_loan_ac_ibfk_6`
    FOREIGN KEY (`approved_by_m`)
    REFERENCES `shg`.`m_profile` (`m_ac_no`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `m_loan_ac_ibfk_7`
    FOREIGN KEY (`loan_source_id`)
    REFERENCES `shg`.`loan_source` (`loan_source_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `shg`.`g_rules` (
  `g_ac_no` BIGINT(20) NOT NULL,
  `max_no_of_core_members` INT(10) NULL,
  `allow_associate_members` INT(10) NULL,
  `cm_monthly_saving` DECIMAL(16,2) NULL,
  `am_min_monthly_saving` DECIMAL(16,2) NULL,
  `am_max_monthly_saving` DECIMAL(16,2) NULL,
  `cm_registration_fee` DECIMAL(16,2) NULL,
  `am_registration_fee` DECIMAL(16,2) NULL,
  `late_fee` DECIMAL(16,2) NULL,
  `cheque_bouncing_penalty` DECIMAL(16,2) NULL,
  `auto_debit_failure_penalty` DECIMAL(16,2) NULL,
  `cm_application_fee` DECIMAL(16,2) NULL,
  `am_application_fee` DECIMAL(16,2) NULL,
  ...
  `add_int_to_saving_after_months` INT(10) NULL,
  `cm_base_int_on_loan` FLOAT NULL,
  `am_base_int_on_loan` FLOAT NULL,
  `int_on_consumption_loan` FLOAT NULL,
  `individual_dev_loan_range1` DECIMAL(16,2) NULL,
  `individual_dev_loan_range2` DECIMAL(16,2) NULL,
  `individual_dev_loan_range3` DECIMAL(16,2) NULL,
  ...
  `project_dev_loan_range1` DECIMAL(16,2) NULL,
  `project_dev_loan_range2` DECIMAL(16,2) NULL,
  `project_dev_loan_range3` DECIMAL(16,2) NULL,
  ...
  `cm_limit_on_consumption_loan` DECIMAL(16,2) NULL,
  `am_limit_on_consumption_loan` DECIMAL(16,2) NULL,
  `cm_min_months_to_con_loan` INT(10) NULL,
  `am_min_months_to_con_loan` INT(10) NULL,
  `cm_saving_x_consumption_loan` INT(10) NULL,
  `am_saving_x_consumption_loan` INT(10) NULL,
  `cm_min_months_to_dev_loan` INT(10) NULL,
  `am_min_months_to_dev_loan` INT(10) NULL,
  `cm_saving_x_dev_loan` FLOAT NULL,
  `am_saving_x_dev_loan` INT(10) NULL,
  `cm_min_months_int_on_loan` INT(10) NULL,
  `am_min_months_int_on_loan` INT(10) NULL,
  ...
  `compute_day_of_month` INT(10) NULL,
  `due_day_of_month` INT(10) NULL,
  `sms_service` INT(10) NULL,
  `mail_service` INT(10) NULL,
  `report_printing_service` INT(10) NULL,
  ...
  `shg_one_cm_reg_charge` DECIMAL(16,2) NULL,
  `shg_one_am_reg_charge` DECIMAL(16,2) NULL,
  `shg_one_cm_loan_pro_fee_percent` FLOAT NULL,
  `shg_one_am_loan_pro_fee_percent` FLOAT NULL,
  `shg_one_min_annual_service_charge` DECIMAL(16,2) NULL,
  `shg_one_max_loan_pro_fee_off` DECIMAL(16,2) NULL,
  `shg_one_billing_cycle_in_months` INT(10) NULL,
  INDEX `g_rules_fk1_idx` (`g_ac_no` ASC),
  INDEX `g_rules_fk2_idx` (`sms_service_lang_id` ASC),
  INDEX `g_rules_fk3_idx` (`mail_service_lang_id` ASC),
  INDEX `g_rules_fk4_idx` (`report_printing_service_lang_id` ASC),
  CONSTRAINT `g_rules_fk1`
    FOREIGN KEY (`g_ac_no`)
    REFERENCES `shg`.`g_profile` (`g_ac_no`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `g_rules_fk2`
    FOREIGN KEY (`sms_service_lang_id`)
    REFERENCES `shg`.`lang` (`lang_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `g_rules_fk3`
    FOREIGN KEY (`mail_service_lang_id`)
    REFERENCES `shg`.`lang` (`lang_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `g_rules_fk4`
    FOREIGN KEY (`report_printing_service_lang_id`)
    REFERENCES `shg`.`lang` (`lang_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `shg`.`g_ac_by_txtype` (
  ...
  INDEX `g_ac_by_txtype_fk2_idx` (`tx_type_id` ASC),
  INDEX `g_ac_by_txtype_fk1_idx` (`g_ac_no` ASC),
  CONSTRAINT `g_ac_by_txtype_fk1`
    FOREIGN KEY (`g_ac_no`)
    REFERENCES `shg`.`g_ac` (`g_ac_no`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `g_ac_by_txtype_fk2`
    FOREIGN KEY (`tx_type_id`)
    REFERENCES `shg`.`tx_type` (`tx_type_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `shg`.`parent_child_group`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `shg`.`parent_child_group` ;

CREATE TABLE IF NOT EXISTS `shg`.`parent_child_group` (
  `parent_g_ac_no` BIGINT(20) NOT NULL,
  `child_g_ac_no` BIGINT(20) NOT NULL,
  `group_relation_id` INT(10) UNSIGNED NOT NULL,
  INDEX `parent_child_group_ibfk_1_idx` (`parent_g_ac_no` ASC),
  INDEX `parent_child_group_ibfk_2_idx` (`child_g_ac_no` ASC),
  INDEX `parent_child_group_ibfk_3_idx` (`group_relation_id` ASC),
  CONSTRAINT `parent_child_group_ibfk_1`
    FOREIGN KEY (`parent_g_ac_no`)
    REFERENCES `shg`.`g_profile` (`g_ac_no`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `parent_child_group_ibfk_2`
    FOREIGN KEY (`child_g_ac_no`)
    REFERENCES `shg`.`g_profile` (`g_ac_no`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `parent_child_group_ibfk_3`
    FOREIGN KEY (`group_relation_id`)
    REFERENCES `shg`.`group_relation` (`group_relation_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
